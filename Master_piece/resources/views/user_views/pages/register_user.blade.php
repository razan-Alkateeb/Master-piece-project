            ...
            <div class="row align-items-center">
                ...
                <div class="col-auto">
                    <div class="header-logo">
                        <a href="index.html"><img src="../img/logonew.png" alt="Logo"
                ...
                <div class="col-auto me-auto">
                    <nav class="site-main-menu site-main-menu-left menu-height-100 justify-content-center">
                        <ul>
                            ...
                            <li class="has-children"><a href="#"><span class="menu-text">Gyms</span></a></li>

                            <li class="has-children"><a href="#"><span class="menu-text">Subscriptions</span></a></li>

                            <li class="has-children"><a href="#"><span class="menu-text">About us</span></a></li>
        ...
        <div class="inner customScroll">
            ...
            <div class="offcanvas-menu">
                <ul>
                    ...
                    <li><a href="#"><span class="menu-text">Gyms</span></a></li>

                    <li><a href="#"><span class="menu-text">Subscriptions</span></a></li>

                    <li><a href="#"><span class="menu-text">About us</span></a></li>
            ...
            <div class="offcanvas-buttons">
                <div class="header-tools">
                    ...
                    <div class="header-wishlist">
                        <a href="#"><button class="btn btn-sm btn-dark btn-outline-hover-dark">LOG IN</button></a>
                    </div>
                    <div class="header-cart">
                        <a href="#"><button class="btn btn-sm btn-dark btn-outline-hover-dark">SIGN UP</button></a>
                    </div>
                </div>
            </div>
                ...
                <div class="row learts-mb-n40">
                    ...
                    <div class="col-lg-3 learts-mb-40">
                        <div class="widget-about">
                            <img src="../img/logonew.png" style="width: 200px" alt="">
