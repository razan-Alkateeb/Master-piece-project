...
<body>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="page-title">
                        <h1 class="title">Product Tabs</h1>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html">Home</a></li>
                            <li class="breadcrumb-item"><a href="#">Elements</a></li>
                            <li class="breadcrumb-item active">Product Tabs</li>
                        </ul>
                    </div>
                                    ...
                                    <div class="product">
                                        <div class="product-thumb">
                                            <a href="product-details.html" class="image">
                                                ...
                                                <img class="image-hover " src="assets/images/product/s270/product-9-hover.webp" alt="Product Image">
                                            </a>
                                            <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                                        </div>
                                        <div class="product-info">
                                    ...
                                    <div class="product">
                                        <div class="product-thumb">
                                            <a href="product-details.html" class="image">
                                                ...
                                                <img class="image-hover " src="assets/images/product/s270/product-10-hover.webp" alt="Product Image">
                                            </a>
                                            <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                                        </div>
                                        <div class="product-info">
    ...
    <div class="section section-padding border-bottom">
        <div class="container">
            <!-- Section Title Start -->
            <div class="section-title2 text-center">
                <h2 class="title">Product Tab Style 02</h2>
            </div>
            <!-- Section Title End -->
            ...
            <div class="row learts-mb-40">
                <div class="col">
                    <ul class="nav text-uppercase justify-content-center mx-n1 mb-n2">
                        <li class="nav-item mx-1 mb-2"><a href="#product-all" data-bs-toggle="tab" class="btn btn-md btn-light btn-hover-primary active">All</a></li>
                        <li class="nav-item mx-1 mb-2"><a href="#product-gift-ideas" data-bs-toggle="tab" class="btn btn-md btn-light btn-hover-primary">Gift ideas</a></li>
                        <li class="nav-item mx-1 mb-2"><a href="#product-home-decor" data-bs-toggle="tab" class="btn btn-md btn-light btn-hover-primary">Home Decor</a></li>
                        <li class="nav-item mx-1 mb-2"><a href="#product-kitchen" data-bs-toggle="tab" class="btn btn-md btn-light btn-hover-primary">Kitchen</a></li>
                        <li class="nav-item mx-1 mb-2"><a href="#product-toys" data-bs-toggle="tab" class="btn btn-md btn-light btn-hover-primary">Toys</a></li>
                    </ul>
                </div>
            </div>
                            ...
                            <div class="product">
                                <div class="product-thumb">
                                    <a href="product-details.html" class="image">
                                        ...
                                        <img class="image-hover " src="assets/images/product/s270/product-23-hover.webp" alt="Product Image">
                                    </a>
                                    <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                                </div>
                                <div class="product-info">
                            ...
                            <div class="product">
                                <div class="product-thumb">
                                    <a href="product-details.html" class="image">
                                        ...
                                        <img class="image-hover " src="assets/images/product/s270/product-16-hover.webp" alt="Product Image">
                                    </a>
                                    <a href="wishlist.html" class="add-to-wishlist hintT-left" data-hint="Add to wishlist"><i class="far fa-heart"></i></a>
                                </div>
                                <div class="product-info">
    ...
    <div class="section section-padding">
        <div class="container">
            <!-- Section Title Start -->
            <div class="section-title2 text-center">
                <h2 class="title">Product Tab Style 03</h2>
            </div>
            <!-- Section Title End -->
            ...
            <div class="row">
                <div class="col-12">
                    <ul class="product-tab-list tab-hover2 nav">
                        <li><a class="active" data-bs-toggle="tab" href="#tab-new-sale-3">New arrivals</a></li>
                    ...
                    <div class="prodyct-tab-content1 tab-content">
                        <div class="tab-pane fade show active" id="tab-new-sale-3">
                            <!-- Products Start -->
                            <div class="products row row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1">
                        ...
                        <div class="tab-pane fade" id="tab-sale-items-3">
                            <!-- Products Start -->
                            <div class="products row row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1">
                        ...
                        <div class="tab-pane fade" id="tab-best-sellers-3">
                            <!-- Products Start -->
                            <div class="products row row-cols-lg-4 row-cols-md-3 row-cols-sm-2 row-cols-1">
