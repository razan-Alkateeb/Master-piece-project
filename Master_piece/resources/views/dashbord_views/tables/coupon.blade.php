                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="row card-header">
                            <h3 class="col-3">Coupons DataTable</h3>
                            <div class="col-2">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->coupon_expire_date }}</td>
                                            <td>{{ $item->coupon_subscription_id }}</td>

                                            <td>
                                                <a href="{{ url('/coupon/' . $item->id . '/edit') }}">
                                                     <button type="button" class="btn btn-success btn-sm">Edit</button></a>

                                                <!-- Delete Admin form (you can use a modal for confirmation) -->
                                                <form method="POST" action="{{ url('/coupon' . '/' . $item->id) }}"
