                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="row card-header">
                            <h3 class="col-2">Type DataTable</h3>
                            <div class="col-2">
                                <a href=" {{ url('/type/create') }}"> <button type="button" class="btn bg-primary ">Add New Type</button></a>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="{{ url('/type' . '/' . $item->id) }}"
